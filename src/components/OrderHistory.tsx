        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Enter your mobile number to view your order history</p>
            </div>
              ...
              {userOrders.length === 0 ? (
                ...
                <>
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600">Your complete order history</p>
                  </div>
                      ...
                      >
                        <div className="p-6">
                          ...
                          <button
                            ...
                            className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white py-2 px-4 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                          >
                ...
                <div className="bg-gray-50 p-4 rounded-xl">
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="font-semibold">{selectedOrder.customerDetails.name}</p>
                    </div>
                    <div>
                      <span className="text-gray-600">Mobile:</span>
                      <p className="font-semibold">+91 {selectedOrder.customerDetails.mobile}</p>
                    </div>
                  </div>
                </div>
