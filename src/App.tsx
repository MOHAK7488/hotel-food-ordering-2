          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {isLoadingMenu ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Loading Menu...</h3>
                <p className="text-gray-600">Please wait while we fetch the latest menu items.</p>
              </div>
            ...
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-auto shadow-2xl">
              <div className="p-4 sm:p-6">
                ...
                <form onSubmit={(e) => { e.preventDefault(); handlePlaceOrder(); }} className="space-y-4 sm:space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isPlacingOrder || !customerDetails.name || !customerDetails.mobile || !customerDetails.roomNumber}
